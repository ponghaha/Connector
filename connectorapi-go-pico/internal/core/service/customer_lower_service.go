...
func (s *customerLowerService) GetCustomerInfoMobileNo(c *gin.Context, getCustomerInfoMobileNoReq domain.GetCustomerInfoMobileNoRequest) domain.GetCustomerInfoMobileNoResult {
	timestamp := time.Now()
